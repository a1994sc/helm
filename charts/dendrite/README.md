...
**This chart is not maintained by the upstream project and any issues with the chart should be raised [here](https://github.com/a1994sc/helm/issues/new/choose)**

This chart was depricated by samip5, however I thought that it had very good bones so I'm going to be hosting it here. I can not promise any active development, but as I use it I will post any changes here.
